...
const Today = () => {
    ...
    let sunsetTime;
    if (currentData) {
        sunriseTime = new Date(currentData.sunrise * 1000);
        sunsetTime = new Date(currentData.sunset * 1000);
    }
                ...
                <div className="today__wrapper">
                    <Row>
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2 h-100">
                                <div className="today__item__title fs-5 text-black-50 mb-3">UV index</div>
                                <div className="UV__item__content text-center">
                                    <div className="UV__item__icon">
                                        <svg
                                            stroke="currentColor"
                                            fill="none"
                                            strokeWidth="2"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">{currentData.uvi}</p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2 h-100">
                                <div className="today__item__title fs-5 text-black-50 mb-3">Wind Status</div>
                                <div className="UV__item__content text-center">
                                    <div className="UV__item__icon">
                                        <svg
                                            stroke="#4590fd"
	...
	z"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">
                                        {(currentData.wind_speed * 3.6).toFixed(2)} km/h
                                    </p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2 h-100">
                                <div className="today__item__title fs-5 text-black-50 mb-3">Sunrise & Sunset</div>
                                <div className="UV__item__content ">
	...
	c-0.19,0.2-0.42,0.3-0.69,0.3h-2.32c-0.26,0-0.48-0.1-0.66-0.29C22.99,15.99,22.9,15.75,22.9,15.47z"
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2">
                                <div className="today__item__title fs-5 text-black-50 mb-3">Humidity</div>
                                <div className="UV__item__content text-center">
                                    <div className="UV__item__icon">
                                        <svg
                                            stroke="#4590fd"
	...
	"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">{currentData.humidity} %</p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2">
                                <div className="today__item__title fs-5 text-black-50 mb-3">Visibility</div>
                                <div className="UV__item__content text-center">
                                    <div className="UV__item__icon">
                                        <svg
                                            stroke="currentColor"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">{currentData.visibility / 1000} km</p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg="4" className="p-3">
                            <div className="today__item p-2">
                                <div className="today__item__title fs-5 text-black-50 mb-3">Pressure</div>
                                <div className="UV__item__content text-center">
                                    <div className="UV__item__icon">
                                        <svg
                                            stroke="#4590fd"
                                    ...
                                    <p className="fs-3 fw-bold text-muted">{currentData.pressure} hPa</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
